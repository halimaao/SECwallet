...
- (instancetype)init {
    ...
    if (self = [super init]) {
        ...
        self.frame = CGRectMake(0, 0, CALScreenWidth, CALScreenHeight - CALStatusBarHeight - CALNavigationBarHeight);
...
- (UIImageView *)scanQRCodePickBackgroundImageView {
    ...
    _scanQRCodePickBackgroundImageView.frame = CGRectMake(self.center.x / 4, self.center.y / 3.5 +40, CALScreenWidth - 100, CALScreenWidth - 100);
