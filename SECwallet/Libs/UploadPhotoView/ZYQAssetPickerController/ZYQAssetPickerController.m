...
- (void)setupButtons
{
    ...
    [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"返回", nil)
                                     style:UIBarButtonItemStylePlain
                                    target:self
                                    action:@selector(dismissPickingAssets:)];
    if([[[UIDevice currentDevice]systemVersion]doubleValue]>=7.0){
        self.navigationItem.rightBarButtonItem.tintColor = TEXT_BLACK_COLOR;
        self.navigationItem.leftBarButtonItem.tintColor = TEXT_BLACK_COLOR;
...
- (void)dismissPickingAssets:(id)sender
{
